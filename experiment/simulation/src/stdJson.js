// JSON object
        var jsonData = {
                    ...
                    "statements": [
                        ...
                        {"step_no": "9", "statement": "TT3 Reduced"},
                        {"step_no": "10", "statement": "Plant shut down"}
...
console.log(jsonData);
		      ...
		      var jsonData1 = {
            		"statements": [
                        {"step_no": "1", "statement": "Inlet feed pump to boiler failed"},
                        {"step_no": "2", "statement": "TSH reaches high turns red"},
                        {"step_no": "3", "statement": "PSH reaches high turns red"},
                        {"step_no": "4", "statement": "LSL reaches low level turns red"},
                        {"step_no": "5", "statement": "SCR turned off"}
