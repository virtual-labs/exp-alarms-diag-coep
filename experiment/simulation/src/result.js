...
//	$("#Header").html("<center><span >BOILER HEAT EXCHANGER PLANT(FAULT & ALARM)</span></center>");
$("#Header").prop("hidden", true);
  ...
  <div style="display: flex; align-items: center; gap: 10px; white-space: nowrap;">
	...
	+'<div class="container-fluid">'
	 +' <div class="row titlePart" id="" ><center><span >Interpret the event and alarm diagram for the smooth running of a plant</span></center></div>' 
	+' <!-- Title -->'
