...
function alamActivity()
{
	...
	seconds = 0;
	  updateCounter();
	//$("#footerModal").empty();
	$("#Header").html("<center><span>ALARMS</span></center>");
...
$(document).ready(function () {
	...
	alamCount++;
        ...
        if (correctCount === jsonData1.statements.length) {
            showModal(` <strong style="color:#153f68;font-size: large;"> All answers are correct. Go to result</strong>`);
